...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jawnz.back.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jawnz.back.security.DomainUserDetailsService", "createSpringSecurityUser");
